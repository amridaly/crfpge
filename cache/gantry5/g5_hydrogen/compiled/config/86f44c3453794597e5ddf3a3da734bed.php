...
return [
    ...
    'timestamp' => 1511198809,
    'checksum' => 'efc3db36c7cba2ebeccd4aac70247dd4',
    'files' => [
    ...
    'data' => [
        ...
        'index' => [
            'name' => 'default',
            'timestamp' => 1511198771,
            'version' => 7,
            'preset' => [
                'image' => 'gantry-admin://images/layouts/default.png',
                'name' => 'default',
                'timestamp' => 1511198770
            ],
            'positions' => [
                'header' => 'Header',
            ...
            'particles' => [
                ...
                'messages' => [
                    'system-messages-6632' => 'System Messages'
                ],
                'content' => [
                    'system-content-3176' => 'Page Content'
                ],
                'copyright' => [
                    'copyright-6893' => 'Copyright'
                ],
                'spacer' => [
                    'spacer-2603' => 'Spacer'
                ],
                'branding' => [
                    'branding-7537' => 'Branding'
                ],
                'mobile-menu' => [
                    'mobile-menu-6755' => 'Mobile-menu'
                ]
            ],
            'inherit' => [
        ...
        'layout' => [
            ...
            'layout' => [
                ...
                '/main/' => [
                    ...
                    1 => [
                        0 => 'system-messages-6632'
                    ],
                    2 => [
                        0 => 'system-content-3176'
                    ]
                ],
                '/footer/' => [
                    0 => [
