...
class jdownloadstree{
    ...
    */
        ...
        if(isset($this->elementArray[$parentID])){			
            ...
            for ($no=0; $no < count($this->elementArray[$parentID]) ;$no++){
				...
				if ($this->elementArray[$parentID][$no][0] != $catid){
                    ...
                    echo "<li class=\"j7dctree_node\"><img height=\"18\" width= \"18\" class=\"tree_plusminus\" id=\"plusMinus".$this->elementArray[$parentID][$no][0]."\" src=\"modules/mod_jdownloads_tree/jdtree/images/plus.gif\" alt=\"\"><img height=\"16\" width= \"16\" src=\"".$this->elementArray[$parentID][$no][4]."\" alt=\"\"><a class=\"j7dctree_link\"$urlAdd>".$this->elementArray[$parentID][$no][1].$amount_sub_cats.$amount_items."</a>";    
                } else { 
                    echo "<li class=\"j7dctree_node\"><img height=\"18\" width= \"18\" class=\"tree_plusminus\" id=\"plusMinus".$this->elementArray[$parentID][$no][0]."\" src=\"modules/mod_jdownloads_tree/jdtree/images/plus.gif\" alt=\"\"><img height=\"16\" width= \"16\" src=\"".$this->elementArray[$parentID][$no][4]."\" alt=\"\">".$this->elementArray[$parentID][$no][1].$amount_sub_cats.$amount_items;      
                }  
	...
	function drawTree($home_link, $moduleclass_sfx, $params){
		...
		if ($params->get('catid') == '') { 
			echo '<img height="18" width="18" src="modules/mod_jdownloads_tree/jdtree/images/base.gif" alt="" /> '.$home_link;
		}
        for($no = 0; $no < count($this->elementArray[0]); $no++){
            ...
            if ($this->elementArray[0][$no][0] != $catid){
                ...
                echo "<li onmouseover=\"this.className='jdmroothov'\" onmouseout=\"this.className='j7dctree_node'\" class=\"j7dctree_node\" id=\"node_".$this->elementArray[0][$no][0]."\"><img height=\"18\" width= \"18\" id=\"plusMinus".$this->elementArray[0][$no][0]."\" class=\"tree_plusminus\" src=\"modules/mod_jdownloads_tree/jdtree/images/plus.gif\" alt=\"\"><img height=\"16\" width= \"16\" src=\"".$this->elementArray[0][$no][4]."\" alt=\"\"><a class=\"j7dctree_link\"$urlAdd>".$this->elementArray[0][$no][1].$amount_sub_cats.$amount_items."</a>";		
            } else {
                echo "<li onmouseover=\"this.className='jdmroothov'\" onmouseout=\"this.className='j7dctree_node'\" class=\"j7dctree_node\" id=\"node_".$this->elementArray[0][$no][0]."\"><img height=\"18\" width= \"18\" id=\"plusMinus".$this->elementArray[0][$no][0]."\" class=\"tree_plusminus\" src=\"modules/mod_jdownloads_tree/jdtree/images/plus.gif\" alt=\"\"><img height=\"16\" width= \"16\" src=\"".$this->elementArray[0][$no][4]."\" alt=\"\">".$this->elementArray[0][$no][1].$amount_sub_cats.$amount_items;        
            }     
