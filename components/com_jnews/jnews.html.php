...
?>
				...
				} else if( form.captcode.value != "version2" && form.security_code.value != form.captcode.value) {
...
?>
		 <div id="joobitoolbar-box">
			 ...
			 <div class="componentheading"><?php
			 	...
			 	if($title == _JNEWS_EMAIL_LISTS OR $title == _JNEWS_MENU_SUBSCRIBERS OR $title == _JNEWS_MENU_NEWSLETTERS OR $title == _JNEWS_MENU_AUTONEWS OR $title == _JNEWS_MENU_AUTOS OR $title == _JNEWS_MENU_STATS_REPORTS OR $title == _JNEWS_LEADS_REP){
                    ...
                    elseif($title == _JNEWS_MENU_SUBSCRIBERS ) $img = 'subscribers.png';
                    elseif($title == _JNEWS_MENU_NEWSLETTERS ) $img = 'newsletter.png';
                    elseif($title == _JNEWS_MENU_AUTONEWS ) $img = 'smartnewsletter.png';
                    elseif($title == _JNEWS_MENU_AUTOS ) $img = 'autoresponder.png';
                    elseif($title == _JNEWS_MENU_STATS_REPORTS ) $img = 'statistics.png';
                    elseif($title == _JNEWS_LEADS_REP) $img = 'leadreport.png';
                    else $img='';
	...
	public static function formEndFN($button='', $values='') {
	 ...
	 public static function formEndYesNo($link, $cle, $subscriberId, $listId) {
		...
		echo '<input type="hidden" name="listid" value="' . (int)$listId . '" /> '."\n\r";
		echo '<input type="hidden" name="subscriber" value="' . (int)$subscriberId.'" /> '."\n\r";
