...
<?php if ($this->faq['featured']): ?>
	<div class="fsf_faq_featured"><img src="<?php echo JURI::root( true ); ?>/components/com_fsf/assets/images/featured.png"	width="16" height="16" /><?php echo JText::_('Featured_faq'); ?></div>
<?php endif; ?>
