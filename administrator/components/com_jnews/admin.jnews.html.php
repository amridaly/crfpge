...
//						echo $editor->save( 'content' );
	...
	?>
			...
			var Joomla = {
				...
				submitform : function (a) {         //v1rus32 15.09.2015 17:59
                                document.adminForm.task.value = a;
                                document.adminForm.submit();
			                    return true;
		                }
	...
	public static function _footer() {
	 ...
	 public static function _footerSignature() {
		...
		echo '<br /><div align="center" class="footer"><span class="footer">'. jnews::version() .
				', <a href="https://joobi.co" target="_blank" class="footer">Joomla extensions</a> powered by Joobi.';
		echo '</span></div>';
    }
...
<?php
	...
	public static function about(){
		...
		jnews::miseEnPage( _JNEWS_LICENSE , '', '<a href="https://joobi.co/index.php?option=com_jlinks&controller=redirect&link=single-license" target="_blank">&copy; Joobi Limited</a>');
		jnews::endOfTable();
		backHTML::formEnd();
		echo '</td>';
		echo '<td width="380px">';
		$logo='jnews_logo'. (!empty($GLOBALS[JNEWS.'type'])?'_'.strtolower($GLOBALS[JNEWS.'type']):'').'.png';
		echo '<a href="https://joobi.co" target="_blank"><img src="https://joobi.co/images/'.$logo.'" alt="jNews Logo" border="0" align="center" /></a>';
		echo '</td>';
		echo '</tr></table>';
	...
	public static function installPRO($button='',$return=''){
		...
		$html .= '<a href="https://joobi.co" target="_blank"><img style="padding-right: 20px;" src="https://joobi.co/images/'.$logo.'" alt="jNews Logo" border="0" align="center" /></a><br>';
		...
		$proStore = '';
		$proStore = '<div style="height: 195px; margin-top: 20px;" class="acaInstallList"><img style="padding-right: 10px" src="https://joobi.co/images/jnews_pro.jpg" align="left">';
		...
		$proStore .= '<a target="_blank" href="https://joobi.co/index.php?option=com_jlinks&controller=redirect&link=jNewsPro">';
	...
	public static function installPlus($button='',$return=''){
		...
		$plusStore = '<div style="height: 195px;" class="acaInstallList"><img style="padding-right: 10px" alt="jNews PLUS" src="https://joobi.co/images/jnews_plus.jpg" align="left">';
		...
		$plusStore .= '<a target="_blank" href="https://joobi.co/index.php?option=com_jlinks&controller=redirect&link=jNewsPLus">';
		...
		$proStore = '';
		$proStore = '<div style="height: 195px; margin-top: 20px;" class="acaInstallList"><img style="padding-right: 20px;" alt="jNews PRO" src="https://joobi.co/images/jnews_pro.jpg" align="left">';
		$proStore .= '<br><b>'._JNEWS_THINK_PRO.'</b><br>';
		$proStore .= '<ul><li>'._JNEWS_THINK_PRO_1.'</li><li>'._JNEWS_THINK_PRO_2.'</li><li>'._JNEWS_THINK_PRO_3.'</li><li>'._JNEWS_THINK_PRO_4.'</li><li>'._JNEWS_THINK_PRO_5.'</li><li>'._JNEWS_THINK_PRO_6.'</li></ul>';
		$proStore .= '<a target="_blank" href="https://joobi.co/index.php?option=com_jlinks&controller=redirect&link=jNewsPro">';
		$proStore .= '<div style="background-image: url('. JNEWS_PATH_ADMIN_IMAGES2 .'btn_white.png); background-repeat:no-repeat; height: 41px; width: 131px; border: none; float:right; padding:10px 0 0 20px; ">';
...
<?php
 ...
 if ((!empty($update->needAdd)) || (!empty($update->needRemove)) || (!empty($update->needUpdate))) {
		...
		?>
			...
			<input type="hidden" name="updatepath" value="<?php echo strtolower( $update->local['component'] .DIRECTORY_SEPARATOR. $update->local['type'] ) .DIRECTORY_SEPARATOR. $update->globalVersion['version'] .DIRECTORY_SEPARATOR; ?>" />
		</form>
		<br />
		<?php
		 }
