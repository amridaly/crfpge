...
define('_JNEWS_CRON_DESC', '<br />Usando la funzione di cronologia puoi assegnare una funzione automatica per il tuo sito Joomla!<br />' .
		...
		'<br /><br />Se ti serve aiuto per sistemarlo o hai qualche problema, visita il nostro forum  <a href="https://joobi.co" target="_blank">https://joobi.co</a>');
// sending settings
...
define('_JNEWS_UPDATE_URL_TIPS', 'Per esempio: https://joobi.co/update/ (compreso lo slash finale)');
