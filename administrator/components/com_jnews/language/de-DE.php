...
define('_JNEWS_CRON_DESC','<br />Wenn Sie die Cron-Funktion nutzen, können Sie eine automatische Aufgabe für Ihre Joomla Webseite einstellen!<br />' .
		...
		' - Cpanel klicken Sie hier ' .
 		...
 		'<br />Wenn Sie Hilfe bei der Einrichtung brauchen oder Probleme haben, benutzen Sie bitte unser Forum <a href="https://joobi.co" target="_blank">https://joobi.co</a>');
// sending settings
...
define("_JNEWS_UPDATE_URL_TIPS","Zum Beispiel: https://joobi.co/update/ (inklusive dem Slash am Ende)");
