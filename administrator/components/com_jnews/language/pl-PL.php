...
define('_JNEWS_CRON_DESC', '<br>Używając funkcji cron-a możesz ustawić automatyczne zadania dla twojego serwisu w Joomla!<br>' .
		...
		' - Cpanel kliknij tu ' .
 		...
 		'<br>Jeśli potrzebujesz pomocy w ustawieniach crona lub masz inne problemy zapraszamy na nasze forum <a href="https://joobi.co" target="_blank">https://joobi.co</a>');
// sending settings
...
define('_JNEWS_UPDATE_URL_TIPS', 'Na przykład: https://joobi.co/update/ (razem z końcowym slash-em)');
