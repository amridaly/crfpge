...
define('_JNEWS_CRON_DESC', ('<br />Genom att använda cron funktionen så kan du ställa in en automatisk uppgift för din hemsida!<br />' .
		...
		'<br /><br />Om du behöver hjälp att ställa in den eller har problem var god och konsultera vårat forum <a href="https://joobi.co" target="_blank">https://joobi.co</a>'));
// sending settings
...
define('_JNEWS_UPDATE_URL_TIPS', ('Som exempel: https://joobi.co/update/ (inkludera det avslutande slashen)'));
...
define( '_JNEWS_UPDATE_CLICK_HERE', ('Besök <a href="https://joobi.co" target="_blank">Joobi</a> för att ladda ner den senaste versionen.'));
