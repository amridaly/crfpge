...
define('_JNEWS_CRON_DESC', ('<br />¡Usando la función de tareas Cron podrá configurar la automatización de trabajos para su sitio Joomla!<br />' .
		...
		'<br /><br />Si usted necesita ayuda para efectuar la configuración o tiene problemas por favor remítase a nuestros foros en <a href="https://joobi.co" target="_blank">https://joobi.co</a>'));
// sending settings
...
define('_JNEWS_UPDATE_URL_TIPS', ('Por ejemplo: https://joobi.co/update/ (incluya la barra de cierre)'));
