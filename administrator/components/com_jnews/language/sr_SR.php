...
Ako vam treba pomoć , potražite naš forum na adresi <a href="https://joobi.co" target="_blank">https://joobi.co</a> ');
// sending settings
...
');
define('_JNEWS_UPDATE_URL_TIPS', 'Na primer: https://joobi.co/update/ (obavezno uneti i kosu crtu na kraju)');
...
define( '_JNEWS_UPDATE_CLICK_HERE', 'Látogasson el a <a href="https://joobi.co" target="_blank">Joobi</a> oldalra a legfrissebb verzió letöltéséhez.');
