...
define('_JNEWS_CRON_DESC','<br />Используя функцию Хрон, Вы можете установить автоматическую задачу, которая будет выполняться по расписанию, для Вашего сайта!<br />' .
		...
		'<br /><br />Если вам понадобится помощь, то получить её можно на форуме разработчиков <a href="https://joobi.co" target="_blank">https://joobi.co</a>');
...
define('_JNEWS_UPDATE_URL_TIPS', 'Пример: https://joobi.co/update/ (Включая закрывающий слеш)');
...
define('_JNEWS_CRON_DOC_URL' , '<a href="https://joobi.co/index.php?option=com_content&Itemid=72&view=category&layout=blog&id=29&limit=60"
...
define( '_JNEWS_UPDATE_CLICK_HERE' , 'Пожалуйста, посетите <a href="https://joobi.co" target="_blank">Joobi</a>, чтобы скачать последнюю версию.');
