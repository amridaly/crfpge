...
define('_JNEWS_CRON_DESC', '<br />Usar a função Cron automatiza tarefas para o seu site Joomla!<br />' .
		...
		'<br /><br />Se precisar de ajuda para parametrizar ou tiver problemas por favor consulte o nosso forum <a href="https://joobi.co" target="_blank">https://joobi.co</a>');
// sending settings
...
define('_JNEWS_UPDATE_URL_TIPS', 'Por exemplo: https://joobi.co/update/ (inclua a barra no final)');
