...
define('_JNEWS_CRON_DESC','<br />使用排程功能你可以為你的 Joomla 網站設定自動化工作!<br />' .
		...
		'<br /><br />如需協助設定或有問題請咨詢我們的討論區 <a href="https://joobi.co" target="_blank">https://joobi.co</a>');
// sending settings
...
define('_JNEWS_UPDATE_URL_TIPS', '例如：https://joobi.co/update/（包括結尾斜線）');
...
define( '_JNEWS_UPDATE_CLICK_HERE' , '請到訪 <a href="https://joobi.co" target="_blank">Joobi</a> 下載最新版本.');
