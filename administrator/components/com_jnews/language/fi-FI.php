...
define('_JNEWS_CRON_DESC','<br />Käyttäen <pre>cron</pre> palvelua voit asettaa automaattisia tehtäviä Joomla sivustollesi!<br />' .
		...
		'<br /><br />Jos tarvitset apua asetuksissa tai sinulla on ongelmia, ole hyvä ja tutustu foorumiimme <a href="https://joobi.co" target="_blank">https://joobi.co</a>');
// sending settings
...
define('_JNEWS_UPDATE_URL_TIPS', 'Esim.: https://joobi.co/update/ (sisällytä lopun kauttaviiva)');
...
define( '_JNEWS_UPDATE_CLICK_HERE' , 'Ole hyvä ja käy <a href="https://joobi.co" target="_blank">Joobi</a> ladataksesi uusimman version.');
...
define('_JNEWS_SHOW_CRON_TIPS','Sallii ajastuksen määrittelyn jNewsiä asennettaessa.<br>Tämä <pre>cron</pre> palvelin sijaitsee osoitteessa https://joobi.co ja toimii varttitunnin välein');
...
define('JNEWS_AUTOMATIC_CRON', 'Oletus <pre>cron</pre> palvelu otetaan käyttön jNewsiä asennettaessa.<br/>Tämä palvelu toimii joobi.co palvelimella ja aktivoituu 15 minuutin välein.');
...
define('_JNEWS_CRON_SYSTEM_TIPS', 'Määrittää jNewsin ajoitettujen tehtävien ajastamiseen käytetyn <pre>cron</pre> palvelun.<br><br> [0] <strong> Ei mitään </strong> - jos et halua lähettää viestejä automaattisesti.' .
		'<br><br>[1] <strong>jNews <pre>cron</pre> liitännäinen</strong> - jos haluat, että <pre>cron</pre> toimii itse sivustolta.<br><br>[2] <strong>Joobi <pre>cron</pre></strong> - jos haluat käyttää ilmaista <a href="https://joobi.co">Joobi</a> <pre>cron</pre> palvelua. ' .
