...
define('_JNEWS_CRON_DESC', '<br />Door de cronfunctie te gebruiken kunt u een automatische taak instellen voor uw Joomla website!<br />' .
		...
		'<br /><br />Als u hulp nodig heeft voor het instellen of heeft u problemen, raadpleeg dan aub ons forum <a href="https://joobi.co" target="_blank">https://joobi.co</a>');
...
define('_JNEWS_UPDATE_URL_TIPS', 'Voorbeeld: https://joobi.co/update/ (schuine streep is belangrijk)');
...
define( '_JNEWS_UPDATE_CLICK_HERE', 'Bezoek aub <a href="https://joobi.co" target="_blank">Joobi</a> om de nieuwste versie te downloaden.');
...
define('_JNEWS_SHOW_CRON_TIPS','Activeert de cron set up tijdens installatie van jNews.<br>Deze cron is ingesteld op https://joobi.co en wordt elke 15 minuten getriggerd');
...
define('JNEWS_AUTOMATIC_CRON', 'Een automatische cron is aangemaakt tijdens de installatie van jNews.<br/>Deze cron is automatisch ingesteld op joobi.co. Deze cron heeft een frequentie van 15 minuten.');
...
define('_JNEWS_CRON_SYSTEM_TIPS', 'Definieert de gebruikte cron voor het automatisch plannen van jNews.<br><br> [0] <strong> Geen cron </strong> - als u automatisch verzenden mailings niet wilt gebruiken.' .
		'<br><br>[1] <strong>jNews Cron systeemplugin</strong> - als u de jNews cron wilt initiëren binnen uw website zelf.<br><br>[2] <strong>Joobi cron</strong> - als u de gratis crontaak van <a href="https://joobi.co">Joobi</a> wilt gebruiken. ' .
