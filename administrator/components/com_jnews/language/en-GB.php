...
define('_JNEWS_CRON_DESC','<br />Using the cron function you can setup an automated task for your Joomla website!<br />' .
		...
		'<br /><br />If you need help setting it up or have problems please consult our forum <a href="https://joobi.co" target="_blank">https://joobi.co</a>');
// sending settings
...
define('_JNEWS_UPDATE_URL_TIPS', 'For example: https://joobi.co/update/ (include the closing slash)');
