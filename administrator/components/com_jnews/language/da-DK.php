...
define('_JNEWS_CRON_DESC', '<br />Ved brug af cron funktionen kan du oprette en automatisk opgave pГҐ din Joomla webside!<br />' .
		...
		'<br /><br />Hvis du har brug for hjГ¦lp til at sГ¦tte op eller har problemer sГҐ konsulter vores forum <a href="https://joobi.co" target="_blank">https://joobi.co</a>');
// sending settings
...
define('_JNEWS_UPDATE_URL_TIPS', 'For eksempel: https://joobi.co/update/ (inkluder den afsluttende skrГҐstreg)');
...
define( '_JNEWS_UPDATE_CLICK_HERE', 'Venligst besГёg <a href="https://joobi.co" target="_blank">Joobi</a> for at downloade den nyeste version.');
