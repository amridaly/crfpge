...
if ( JFile::exists(JNEWS_JPATH_ROOT .DIRECTORY_SEPARATOR.'components'.DIRECTORY_SEPARATOR.'com_jnews'.DIRECTORY_SEPARATOR.'defines.php') ) {
	...
	define('_jnewsCLASS', JNEWS_JPATH_ROOT_NO_ADMIN .DIRECTORY_SEPARATOR.'administrator'.DIRECTORY_SEPARATOR.'components'.DIRECTORY_SEPARATOR.JNEWS_OPTION.DIRECTORY_SEPARATOR.'classes'.DIRECTORY_SEPARATOR.'class.jnews.php');
...
class getjNewsTab extends cbTabHandler {
    ...
    function getDisplayTab( $tab, $user, $ui) {
      ...
      $html = '';
    require_once(JNEWS_JPATH_ROOT_NO_ADMIN .DIRECTORY_SEPARATOR.'administrator'.DIRECTORY_SEPARATOR.'components'.DIRECTORY_SEPARATOR.JNEWS_OPTION.DIRECTORY_SEPARATOR.'classes'.DIRECTORY_SEPARATOR.'class.jnews.php');
	...
	require_once(JNEWS_JPATH_ROOT_NO_ADMIN .DIRECTORY_SEPARATOR.'administrator'.DIRECTORY_SEPARATOR.'components'.DIRECTORY_SEPARATOR.JNEWS_OPTION.DIRECTORY_SEPARATOR.'classes'.DIRECTORY_SEPARATOR.'class.lists.php');
	require_once(JNEWS_JPATH_ROOT_NO_ADMIN .DIRECTORY_SEPARATOR.'administrator'.DIRECTORY_SEPARATOR.'components'.DIRECTORY_SEPARATOR.JNEWS_OPTION.DIRECTORY_SEPARATOR.'views'.DIRECTORY_SEPARATOR.'subscribers.jnews.html.php');
...
//      $lists = jNews_ListsSubs::getSubscriberLists( $subscriberId );
	...
	function getEditTab( $tab, $user, $ui) {
		...
		if (!empty($my->id)) {
	     	...
	     	$subscriberId = jNews_Subscribers::getSubscriberIdFromUserId( $user->id );
	        $qid[0] = $subscriberId;
			$subscriber = jNews_Subscribers::getSubscribersFromId($qid, false);
			$queues = jNews_ListsSubs::getSubscriberLists( $subscriberId );
