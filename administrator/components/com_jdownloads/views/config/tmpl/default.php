                ...
                <table cellpadding="4" cellspacing="1" border="0" class="adminlist">
                  <tr>
                      <td valign="top" align="left" width="100%">
                        ...
                        <tr>
                        <td valign="top" width="330"><strong><?php echo JText::_('COM_JDOWNLOADS_BACKEND_SETTINGS_UPLOADDIR_UNCATEGORISED')." "; ?></strong><br />
                        ...
                        <tr>
                        <td valign="top" width="330"><strong><?php echo JText::_('COM_JDOWNLOADS_BACKEND_SETTINGS_UPLOADDIR_PREVIEW')." "; ?></strong><br />
                             <?php echo $jlistConfig['files.uploaddir'].'/<br />'; ?> 
                        ...
                        <tr>
                        <td valign="top" width="330"><strong><?php echo JText::_('COM_JDOWNLOADS_BACKEND_SETTINGS_UPLOADDIR_PRIVATE')." "; ?></strong><br />
                             <?php echo $jlistConfig['files.uploaddir'].'/<br />'; ?> 
                        ...
                        <tr>
                        <td valign="top" width="330"><strong><?php echo JText::_('COM_JDOWNLOADS_BACKEND_SETTINGS_UPLOADDIRTEMP')." "; ?></strong><br />
                            <?php echo $jlistConfig['files.uploaddir'].'/<br />'; ?> 
                        ...
                        <tr>
                        <td valign="top" width="330"><strong><?php echo JText::_('COM_JDOWNLOADS_BACKEND_SETTINGS_DATETIME')." "; ?></strong><br />
                        ...
                        <tr>
                        <td valign="top" width="330"><strong><?php echo JText::_('COM_JDOWNLOADS_BACKEND_SETTINGS_DATETIME_SHORT')." "; ?></strong><br />
                        ...
                        <tr>
                        <td valign="top" width="330"><strong><?php echo JText::_('COM_JDOWNLOADS_BACKEND_SETTINGS_FRONTEND_ZIPFILE_PREFIX_TEXT')." "; ?></strong><br />
                        ...
                        <td>
                         ...
                         <tr>
                        <td valign="top" width="330"><strong><?php echo JText::_('COM_JDOWNLOADS_BACKEND_SETTINGS_DEL_TEMPFILE_TIME')." "; ?></strong><br />
                        ...
                        <tr>
                        <td valign="top" width="330"><strong><?php echo JText::_('COM_JDOWNLOADS_BACKEND_SETTINGS_DIRECT_DOWNLOAD_ACTIVE_TITLE')." "; ?></strong><br />
                        ...
                        <tr>
                        <td valign="top" width="330"><strong><?php echo JText::_('COM_JDOWNLOADS_BACKEND_SETTINGS_USE_SRIPT_FOR_DOWNLOAD_TITLE')." "; ?></strong><br />
                        ...
                        <tr>
                        <td valign="top" width="330"><strong><?php echo JText::_('COM_JDOWNLOADS_BACKEND_SET_LOGGING_TITLE')." "; ?></strong><br />
                        ...
                        <tr>
                        <td valign="top" width="330"><strong><?php echo JText::_('COM_JDOWNLOADS_BACKEND_SETTINGS_FRONTEND_VIEW_FILE_TYPES')." "; ?></strong><br />
                        ...
                        <tr>
                        <td valign="top" width="330"><strong><?php echo JText::_('COM_JDOWNLOADS_BACKEND_SETTINGS_IMAGES_DELETE')." "; ?></strong><br />
                        ...
                        <tr>
                        <td valign="top" width="330"><strong><?php echo JText::_('COM_JDOWNLOADS_BACKEND_SETTINGS_PREVIEW_DELETE')." "; ?></strong><br />
                ...
                <table cellpadding="4" cellspacing="1" border="0" class="adminlist">
                  <tr>
                      <td valign="top" align="left" width="100%">
                        ...
                        <tr>
                        <td valign="top" width="330"><strong><font color="#990000"><?php echo JText::_('COM_JDOWNLOADS_BACKEND_OFFLINE_OPTION_TITLE')." "; ?></font></strong><br />
                        ...
                        <tr>
                        <td valign="top" width="330"><strong><?php echo JText::_('COM_JDOWNLOADS_BACKEND_OFFLINE_MESSAGE_TITLE')." "; ?></strong><br />
                        ...
                        <tr><td colspan="2"><hr></td></tr>
                        <tr>
                        <td valign="top" width="330"><strong><?php echo JText::_('COM_JDOWNLOADS_BACKEND_SETTINGS_FRONTEND_COMPO_TEXT')." "; ?></strong><br />
                        ...
                        <tr>
                        <td valign="top" width="330"><strong><?php echo JText::_('COM_JDOWNLOADS_BACKEND_SETTINGS_FRONTEND_FOOTER_TEXT_TITLE')." "; ?></strong><br />
                        ...
                        <tr>
                        <td valign="top" width="330"><strong><?php echo JText::_('COM_JDOWNLOADS_ROBOTS_LABEL')." "; ?></strong><br />
                             <?php
                        ...
                        <tr><td colspan="2"><hr></td></tr>
                        <tr>
                        <td valign="top" width="330"><strong><?php echo JText::_('COM_JDOWNLOADS_BACKEND_SETTINGS_FRONTEND_CATLISTBOX_ACTIVE')." "; ?></strong><br />
                        ...
                        <tr>
                        <td valign="top" width="330"><strong><?php echo JText::_('COM_JDOWNLOADS_BACKEND_SETTINGS_FRONTEND_CATLISTBOX_LEVELS')." "; ?></strong><br />
                        ...
                        <tr>
                        <td valign="top" width="330"><strong><?php echo JText::_('COM_JDOWNLOADS_BACKEND_SETTINGS_FRONTEND_CATLISTBOX_UNCAT_ACTIVE')." "; ?></strong><br />
                        ...
                        <tr>
                        <td valign="top" width="330"><strong><?php echo JText::_('COM_JDOWNLOADS_BACKEND_SETTINGS_FRONTEND_CATLISTBOX_ALL_ACTIVE')." "; ?></strong><br />
                        ...
                        <!--
                        <tr>
                        <td valign="top" width="330"><strong><?php echo JText::_('COM_JDOWNLOADS_BACKEND_SETTINGS_FRONTEND_CATLISTBOX_TOP_ACTIVE')." "; ?></strong><br />
                        ...
                        <tr>
                        <td valign="top" width="330"><strong><?php echo JText::_('COM_JDOWNLOADS_BACKEND_SETTINGS_FRONTEND_CATLISTBOX_NEW_ACTIVE')." "; ?></strong><br />
                        ...
                        <tr>
                        <td valign="top" width="330"><strong><?php echo JText::_('COM_JDOWNLOADS_BACKEND_SETTINGS_CAT_VIEW_INFO_IN_LISTS_TITLE')." "; ?></strong><br />
                        ...
                        <tr>
                        <td valign="top" width="330"><strong><?php echo JText::_('COM_JDOWNLOADS_BACKEND_SETTINGS_VIEW_DETAILSITE_TITLE')." "; ?></strong><br />
                        ...
                        <tr>
                        <td valign="top" width="330"><strong><?php echo JText::_('COM_JDOWNLOADS_BACKEND_SETTINGS_USE_TITLE_AS_LINK_TITLE')." "; ?></strong><br />
                        ...
                        <tr>
                        <td valign="top" width="330"><strong><?php echo JText::_('COM_JDOWNLOADS_BACKEND_SETTINGS_VIEW_PAGENAVI_TOP_TITLE')." "; ?></strong><br />
                        ...
                        <tr>
                        <td valign="top" width="330"><strong><?php echo JText::_('COM_JDOWNLOADS_BACKEND_SETTINGS_VIEW_PAGENAVI_BOTTOM_TITLE')." "; ?></strong><br />
                        ...
                        <tr>
                        <td valign="top" width="330"><strong><?php echo JText::_('COM_JDOWNLOADS_BACKEND_SETTINGS_VIEW_PAGENAVI_SUBCATS_TITLE')." "; ?></strong><br />
                        ...
                        <tr>
                        <td valign="top" width="330"><strong><?php echo JText::_('COM_JDOWNLOADS_BACKEND_SETTINGS_PAGENAVI_AMOUNT_SUBCATS_TITLE')." "; ?></strong><br />
                        ...
                        <tr>
                        <td valign="top" width="330"><strong><?php echo JText::_('COM_JDOWNLOADS_BACKEND_SETTINGS_VIEW_EMPTY_CATEGORIES')." "; ?></strong><br />
                        ...
                        <tr>
                        <td valign="top" width="330"><strong><?php echo JText::_('COM_JDOWNLOADS_BACKEND_SETTINGS_VIEW_NO_FILE_MSG')." "; ?></strong><br />
                        ...
                        <tr><td colspan="2"><hr></td></tr>
                        <tr>
                        <td valign="top" width="330"><strong><?php echo JText::_('COM_JDOWNLOADS_BACKEND_SET_VIEW_FE_ORDERING_TITLE')." "; ?></strong><br />
                        ...
                        <tr>
                        <td valign="top" width="330"><strong><?php echo JText::_('COM_JDOWNLOADS_FE_SORT_ORDER_TITLE')." "; ?></strong><br />
                            <?php
                            $sortorder_current = explode(',', $jlistConfig['sortorder.fields']);
                            $inputbox = JHtml::_('select.genericlist', $this->select_fields['sortbar_items'], 'sortorder_fields[]', 'multiple="multiple" size="7" class="inputbox"', 'value', 'text', $sortorder_current);
                            echo $inputbox; ?>
                        </td>
                        <td valign="top">
                        <?php echo JText::_('COM_JDOWNLOADS_FE_SORT_ORDER_DESK');?>
                        </td>
                        </tr>                         
                        <tr><td colspan="2"><hr></td></tr>                        
                        
                        <tr>
                        <td valign="top" width="330"><strong><?php echo JText::_('COM_JDOWNLOADS_BACKEND_SETTINGS_FRONTEND_BACK_BUTTON')." "; ?></strong><br />
                        ...
                        <tr>
                        <td valign="top" width="330"><strong><?php echo JText::_('COM_JDOWNLOADS_BACKEND_USE_PIC_AND_TEXT_FOR_DOWNLOAD_TITLE')." "; ?></strong><br />
                        ...
                        <tr>
                        <td valign="top" width="330"><strong><?php echo JText::_('COM_JDOWNLOADS_BACKEND_SET_REMOVE_TITLE_TITLE')." "; ?></strong><br />
                        ...
                        <tr>
                        <td valign="top" width="330"><strong><?php echo JText::_('COM_JDOWNLOADS_BACKEND_DEL_EMPTY_TAGS_TITLE')." "; ?></strong><br />
                        ...
                        <tr>
                        <td valign="top" width="330"><strong><?php echo JText::_('COM_JDOWNLOADS_BACKEND_SETTINGS_USE_LIGHTBOX_TITLE')." "; ?></strong><br />
                        ...
                        <tr>
                        <td valign="top" width="330"><strong><?php echo JText::_('COM_JDOWNLOADS_BACKEND_SET_CONTENT_SUPPORT_FOR_ALL_TITLE')." "; ?></strong><br />
                        ...
                        <tr>
                        <td valign="top" width="330"><strong><?php echo JText::_('COM_JDOWNLOADS_BACKEND_SET_CONTENT_SUPPORT_FOR_DESC_TITLE')." "; ?></strong><br />
                        ...
                        <!-- <tr>
                        <td valign="top" width="330"><strong><?php echo JText::_('COM_JDOWNLOADS_BACKEND_SET_SEF_ROUTER_OPTION_TITLE')." "; ?></strong><br />
                        ...
                        <tr>
                        <td valign="top" width="330"><strong><?php echo JText::_('COM_JDOWNLOADS_BACKEND_SETTINGS_USE_REAL_NAME_IN_FRONTEND')." "; ?></strong><br />
                        ...
                        <tr>
                        <td valign="top" width="330"><strong><?php echo JText::_('COM_JDOWNLOADS_BACKEND_SETTINGS_SHORTENED_FILENAME_TITLE')." "; ?></strong><br />
                        ...
                        <!--
                        <tr>
                        <td valign="top" width="330"><strong><?php echo JText::_('COM_JDOWNLOADS_BACKEND_SETTINGS_HOW_MANY_IMAGES')." "; ?></strong><br />
                                <input name="jlistConfig[fe.upload.amount.of.pictures]" value="<?php echo $jlistConfig['fe.upload.amount.of.pictures']; ?>" size="5" maxlength="4"/>
                        </td>
                        <td>
                        ...
                        -->
                        <tr>
                        <td valign="top" width="330"><strong><?php echo JText::_('COM_JDOWNLOADS_BACKEND_SET_REDIRECT_FOR_DOWNLOAD_TITLE')." "; ?></strong><br />
                        ...
                        <tr><td colspan="2"><hr></td></tr> 
                        <tr>
                        <td valign="top" width="330"><strong><?php echo JText::_('COM_JDOWNLOADS_BACKEND_SET_USE_TABS_TITLE')." "; ?></strong><br />
                        ...
                        <tr>
                        <td valign="top" width="330"><strong><?php echo JText::_('COM_JDOWNLOADS_BACKEND_SET_CUSTOM_TAB_TITLES_TITLE')." (1)"; ?></strong><br />
                               <input name="jlistConfig[additional.tab.title.1]" value="<?php echo htmlspecialchars($jlistConfig['additional.tab.title.1'], ENT_QUOTES ); ?>" size="50" maxlength="500"/>
                        </td>
                        <td>
                            <br />
                        ...
                        <tr>
                        <td valign="top" width="330"><strong><?php echo JText::_('COM_JDOWNLOADS_BACKEND_SET_CUSTOM_TAB_TITLES_TITLE')." (2)"; ?></strong><br />
                               <input name="jlistConfig[additional.tab.title.2]" value="<?php echo htmlspecialchars($jlistConfig['additional.tab.title.2'], ENT_QUOTES ); ?>" size="50" maxlength="500"/>
                        </td>
                        
                        </tr>
                        <tr>
                        <td valign="top" width="330"><strong><?php echo JText::_('COM_JDOWNLOADS_BACKEND_SET_CUSTOM_TAB_TITLES_TITLE')." (3)"; ?></strong><br />
                               <input name="jlistConfig[additional.tab.title.3]" value="<?php echo htmlspecialchars($jlistConfig['additional.tab.title.3'], ENT_QUOTES ); ?>" size="50" maxlength="500"/>
                        </td>
                        </tr>
                                                                                                
                        <tr><td colspan="2"> <hr> </td> </tr>
                        <tr>
                        <td valign="top" width="330"><strong><?php echo JText::_('COM_JDOWNLOADS_BACKEND_USE_CUT_DESCRIPTION_TITLE')." "; ?></strong><br />
                        ...
                        <tr>
                        <td valign="top" width="330"><strong><?php echo JText::_('COM_JDOWNLOADS_BACKEND_USE_CUT_DESCRIPTION_LENGTH_TITLE')." "; ?></strong><br />
                                <input name="jlistConfig[auto.file.short.description.value]" value="<?php echo $jlistConfig['auto.file.short.description.value']; ?>" size="10" maxlength="10"/>
                        </td>
                        <td>
                        <?php echo '';?>
                        </td>
                        ...
                        <tr><td colspan="2"><hr></td></tr>
                        <tr>
                        <td valign="top" width="330"><strong><?php echo JText::_('COM_JDOWNLOADS_BACKEND_SETTINGS_RATING_ON_TITLE')." "; ?></strong><br />
                        ...
                        <tr>
                        <td valign="top" width="330"><strong><?php echo JText::_('COM_JDOWNLOADS_BACKEND_SETTINGS_RATING_ONLY_REGGED_TITLE')." "; ?></strong><br />
                        ...
                        <tr><td colspan="2"><hr></td></tr>                                                
                        <tr>
                        <td valign="top" width="330"><strong><?php echo JText::_('COM_JDOWNLOADS_BACKEND_SETTINGS_FRONTEND_CHECKBOX_TEXT')." "; ?></strong><br />
                        ...
                        <tr>
                        <td valign="top" width="330"><strong><?php echo JText::_('COM_JDOWNLOADS_BACKEND_SETTINGS_FRONTEND_CATS_PER_SIDE')." "; ?></strong><br />
                        ...
                        <tr>
                        <td valign="top" width="330"><strong><?php echo JText::_('COM_JDOWNLOADS_BACKEND_SETTINGS_FRONTEND_FILES_PER_SIDE')." "; ?></strong><br />
                        ...
                        <tr><td colspan="2"><hr></td></tr>
                        <tr>
                        <td valign="top" width="330"><strong><?php echo JText::_('COM_JDOWNLOADS_BACKEND_SETTINGS_FRONTEND_SORTCATSORDER_TEXT')." "; ?></strong><br />
                        <?php
                        ...
                        <tr>
                        <td valign="top" width="330"><strong><?php echo JText::_('COM_JDOWNLOADS_BACKEND_SETTINGS_FRONTEND_SORTFILESORDER_TEXT')." "; ?></strong><br />
                        <?php
                        ...
                        <tr>
                        <td valign="top" width="330"><font color="#990000"><strong><?php echo JText::_('COM_JDOWNLOADS_BACKEND_SETTINGS_JCOMMENTS_TITLE')." "; ?></strong></font><br />
                        ...
                        <tr>
                        <td valign="top" width="330"><strong><?php echo JText::_('COM_JDOWNLOADS_BACKEND_SETTINGS_JCOMMENTS_VIEW_SUM_TITLE')." "; ?></strong><br />
                ...
                <tr>
                    <td valign="top" align="left" width="100%">
                       <table width="100%">
                        ...
                        <tr>
                        <td valign="top" width="330"><br /><strong><?php echo JText::_('COM_JDOWNLOADS_BACKEND_SETTINGS_EDITOR_FILES')." "; ?></strong><br />
                        ...
                        <tr>
                        <td valign="top" width="330"><br /><strong><?php echo JText::_('COM_JDOWNLOADS_BACKEND_SETTINGS_EDITOR_CATS')." "; ?></strong><br />
                        ...
                        <tr>
                        <td valign="top" width="330"><br /><strong><?php echo JText::_('COM_JDOWNLOADS_BACKEND_SETTINGS_EDITOR_LICENSES')." "; ?></strong><br />
                        ...
                        <tr>
                        <td valign="top" width="330"><br /><strong><?php echo JText::_('COM_JDOWNLOADS_BACKEND_SETTINGS_EDITOR_LAYOUTS')." "; ?></strong><br />
                        ...
                        <tr>
                        <td valign="top" width="330"><strong><?php echo JText::_('COM_JDOWNLOADS_BACKEND_SETTINGS_FILE_LANGUAGE_LIST')." "; ?></strong><br />
                        ...
                        <tr>
                        <td valign="top" width="330"><strong><?php echo JText::_('COM_JDOWNLOADS_BACKEND_SETTINGS_FILE_SYSTEM_LIST')." "; ?></strong><br />
                ...
                <tr>
                    <td valign="top" align="left" width="100%">
                       <table width="100%">
                        ...
                        <tr>
                        <td valign="top" width="330"><strong><?php echo JText::_('COM_JDOWNLOADS_BACKEND_SETTINGS_USE_UNICODE_TITLE')." "; ?></strong><br />
                        ...
                        <tr>
                        <td valign="top" width="330"><strong><?php echo JText::_('COM_JDOWNLOADS_CONFIG_UPLOAD_FILENAME_BLANK_TITLE')." "; ?></strong><br />
                       ...
                       <tr>
                        <td valign="top" width="330"><strong><?php echo JText::_('COM_JDOWNLOADS_CONFIG_UPLOAD_FILENAME_LOW_TITLE')." "; ?></strong><br />
                        ...
                        <tr>
                        <td valign="top" width="330"><strong><?php echo JText::_('COM_JDOWNLOADS_CONFIG_UPLOAD_FILENAME_SPECIAL_TITLE')." "; ?></strong><br />
                       ...
                       <table width="100%">
                           ...
                           <tr>
                                ...
                                <td width="200px"><?php echo JText::_('COM_JDOWNLOADS_BACKEND_SET_ADD_FIELDS_FIELD_TITLE'); ?><br />
                                        <input class="jd-input" name="jlistConfig[custom.field.1.title]" value="<?php echo stripslashes(htmlspecialchars($jlistConfig['custom.field.1.title'])); ?>" size="50" maxlength="500"/>
                                </td>
                           ...
                           <tr>
                                <td width="5px">2. </td> 
                                <td width="200px">
                                        <input class="jd-input" name="jlistConfig[custom.field.2.title]" value="<?php echo stripslashes(htmlspecialchars($jlistConfig['custom.field.2.title'])); ?>" size="50" maxlength="500"/>
                                </td>
                                <td width="230px">
                           ...
                           <tr>
                                <td width="5px">3. </td> 
                                <td width="200px">
                                        <input class="jd-input" name="jlistConfig[custom.field.3.title]" value="<?php echo stripslashes(htmlspecialchars($jlistConfig['custom.field.3.title'])); ?>" size="50" maxlength="500"/>
                                </td>
                                <td width="230px">
                           ...
                           <tr>
                                <td width="5px">4. </td> 
                                <td width="200px">
                                        <input class="jd-input" name="jlistConfig[custom.field.4.title]" value="<?php echo stripslashes(htmlspecialchars($jlistConfig['custom.field.4.title'])); ?>" size="50" maxlength="500"/>
                                </td>
                                <td width="230px">
                           ...
                           <tr>
                                <td width="5px">5. </td> 
                                <td width="200px">
                                        <input class="jd-input" name="jlistConfig[custom.field.5.title]" value="<?php echo stripslashes(htmlspecialchars($jlistConfig['custom.field.5.title'])); ?>" size="50" maxlength="500"/>
                                </td>
                                <td width="230px">
                          ...
                          <th class="adminheading" colspan="3"><?php echo JText::_('COM_JDOWNLOADS_BACKEND_SET_ADD_FIELDS_FIELD_TYPE')." ".JText::_('COM_JDOWNLOADS_BACKEND_SET_ADD_FIELDS_INPUT_FIELD_TYPE'); ?></th>     
                           ...
                           <tr>
                                ...
                                <td width="200px"><?php echo JText::_('COM_JDOWNLOADS_BACKEND_SET_ADD_FIELDS_FIELD_TITLE')." "; ?><br />
                                        <input class="jd-input" name="jlistConfig[custom.field.6.title]" value="<?php echo stripslashes(htmlspecialchars($jlistConfig['custom.field.6.title'])); ?>" size="50" maxlength="500"/>
                                </td>
                           ...
                           <tr>
                                <td width="5px">7. </td> 
                                <td width="200px">
                                        <input class="jd-input" name="jlistConfig[custom.field.7.title]" value="<?php echo stripslashes(htmlspecialchars($jlistConfig['custom.field.7.title'])); ?>" size="50" maxlength="500"/>
                                </td>
                                <td width="230px">
                           ...
                           <tr>
                                <td width="5px">8. </td> 
                                <td width="200px">
                                        <input class="jd-input" name="jlistConfig[custom.field.8.title]" value="<?php echo stripslashes(htmlspecialchars($jlistConfig['custom.field.8.title'])); ?>" size="50" maxlength="500"/>
                                </td>
                                <td width="230px">
                           ...
                           <tr>
                                <td width="5px">9. </td> 
                                <td width="200px">
                                        <input class="jd-input" name="jlistConfig[custom.field.9.title]" value="<?php echo stripslashes(htmlspecialchars($jlistConfig['custom.field.9.title'])); ?>" size="50" maxlength="500"/>
                                </td>
                                <td width="230px">
                           ...
                           <tr>
                                <td width="5px">10. </td> 
                                <td width="200px">
                                        <input class="jd-input" name="jlistConfig[custom.field.10.title]" value="<?php echo stripslashes(htmlspecialchars($jlistConfig['custom.field.10.title'])); ?>" size="50" maxlength="500"/>
                                </td>
                                <td width="230px">
                           ...
                           <tr>
                                ...
                                <td width="200px"><?php echo JText::_('COM_JDOWNLOADS_BACKEND_SET_ADD_FIELDS_FIELD_TITLE')." "; ?><br />
                                        <input class="jd-input" name="jlistConfig[custom.field.11.title]" value="<?php echo stripslashes(htmlspecialchars($jlistConfig['custom.field.11.title'])); ?>" size="50" maxlength="500"/>
                                </td>
                            </tr>
                            <tr>
                                <td width="5px">12. </td> 
                          ...
                          <tr>
                                ...
                                <td width="200px"><?php echo JText::_('COM_JDOWNLOADS_BACKEND_SET_ADD_FIELDS_FIELD_TITLE')." "; ?><br />
                                        <input class="jd-input" name="jlistConfig[custom.field.13.title]" value="<?php echo stripslashes(htmlspecialchars($jlistConfig['custom.field.13.title'])); ?>" size="50" maxlength="500"/>
                                </td>
                          </tr><tr>
                  ...
                  <tr>
                      <td valign="top" align="left" width="100%">
                        ...
                        <tr>
                         ...
                         <tr>
                             <td valign="top" width="330"><strong><?php echo JText::_('COM_JDOWNLOADS_BACKEND_SETTINGS_NEW_PIC_TITLE')." "; ?></strong><br />
                        ...
                        <tr>
                            <td valign="top" width="330"><strong><?php echo JText::_('COM_JDOWNLOADS_BACKEND_SETTINGS_HOT_PIC_TITLE')." "; ?></strong><br />
                        ...
                        <tr>
                            <td valign="top" width="330"><strong><?php echo JText::_('COM_JDOWNLOADS_BACKEND_SETTINGS_UPDATED_PIC_TITLE')." "; ?></strong><br />
                        ...
                        <tr>
                        <td valign="top" width="330"><strong><?php echo JText::_('COM_JDOWNLOADS_BACKEND_SETTINGS_NEW_TITLE')." "; ?></strong><br />
                        ...
                        <tr>
                            <td valign="top" width="330"><strong><?php echo JText::_('COM_JDOWNLOADS_BACKEND_SETTINGS_HOT_TITLE')." "; ?></strong><br />
                        ...
                        <tr>
                            <td valign="top" width="330"><strong><?php echo JText::_('COM_JDOWNLOADS_BACKEND_SETTINGS_UPD_TITLE')." "; ?></strong><br />
                        ...
                        <tr>
                            <td valign="top" width="330"><strong><?php echo JText::_('COM_JDOWNLOADS_BACKEND_SETTINGS_DETAILS_DOWNLOAD_BUTTON_TITLE')." "; ?></strong><br />
                        ...
                        <tr>
                            <td valign="top" width="330"><strong><?php echo JText::_('COM_JDOWNLOADS_BACKEND_SETTINGS_FILES_DOWNLOAD_BUTTON_TITLE')." "; ?></strong><br />
                        ...
                        <tr>
                            <td valign="top" width="330"><strong><?php echo JText::_('COM_JDOWNLOADS_BACKEND_SETTINGS_DETAILS_MIRROR_BUTTON_TITLE1')." "; ?></strong><br />
                        ...
                        <tr>
                            <td valign="top" width="330"><strong><?php echo JText::_('COM_JDOWNLOADS_BACKEND_SETTINGS_DETAILS_MIRROR_BUTTON_TITLE2')." "; ?></strong><br />
                      ...
                      <th class="adminheading" colspan="2"><?php echo JText::_('COM_JDOWNLOADS_BACKEND_SETTINGS_GLOBAL_THUMBNAILS_HEAD')." "; ?></th>
                        ...
                        <tr>
                        <td valign="top" width="330"><strong><?php echo JText::_('COM_JDOWNLOADS_CONFIG_SETTINGS_THUMBS_CREATE_ALL_NEW_TITLE')." "; ?></strong><br />
                        ...
                        <tr><td colspan="3"><hr></td></tr>
                        <tr>
                        <td valign="top" width="330"><strong><?php echo JText::_('COM_JDOWNLOADS_BACKEND_CREATE_AUTO_THUMBS_BY_PICS_TITLE')." "; ?></strong><br />
                        ...
                        <tr>
                        <td valign="top" width="330"><strong><?php echo JText::_('COM_JDOWNLOADS_BACKEND_CREATE_AUTO_THUMBS_BY_PICS_SCAN_TITLE')." "; ?></strong><br />
                        ...
                        <tr><td colspan="3"><hr></td></tr>
                        <tr>
                        <td valign="top" width="330"><strong><?php echo JText::_('COM_JDOWNLOADS_BACKEND_CREATE_PDF_THUMB_TITLE')." "; ?></strong><br />
                        ...
                        <tr>
                         <td valign="top" width="330"><strong><?php echo JText::_('COM_JDOWNLOADS_BACKEND_IMAGICK_PATH')." "; ?></strong><br />
                        ...
                        <tr>
                        <td valign="top" width="330"><strong><?php echo JText::_('COM_JDOWNLOADS_CONFIG_SETTINGS_PDF_THUMBS_IMAGE_TYPE_TITLE')." "; ?></strong><br />
                        ...
                        <tr><td colspan="3"><hr></td></tr>       
                        <tr>
                        <td valign="top" width="330"><strong><?php echo JText::_('COM_JDOWNLOADS_BACKEND_SETTINGS_VIEW_PLACEHOLDER_TITLE')." "; ?></strong><br />
                        ...
                        <tr>
                        <td valign="top" width="330"><br /><strong><?php echo JText::_('COM_JDOWNLOADS_BACKEND_SETTINGS_VIEW_PLACEHOLDER_IN_LIST_TITLE')." "; ?></strong><br />
                  ...
                  <tr>
                      <td valign="top" align="left" width="100%">
                       ...
                       <tr>
                        ...
                        <tr>
                        <td valign="top" width="330"><strong><?php echo JText::_('COM_JDOWNLOADS_BACKEND_SETTINGS_HTML5_USE_TITLE')." "; ?></strong><br />
                        ...
                        <tr>
                        <td valign="top" width="330"><strong><?php echo JText::_('COM_JDOWNLOADS_BACKEND_SETTINGS_FLOW_BOX_ONLY_IN_DETAILS_TITLE')." "; ?></strong><br />
                        ...
                        <tr>
                        <td valign="top" width="330"><strong><?php echo JText::_('COM_JDOWNLOADS_BACKEND_SETTINGS_HTML5_BOX_WIDTH_TITLE')." "; ?></strong><br />
                        ...
                        <tr>
                        <td valign="top" width="330"><strong><?php echo JText::_('COM_JDOWNLOADS_BACKEND_SETTINGS_HTML5_BOX_HEIGHT_TITLE')." "; ?></strong><br />
                        ...
                        <tr>
                        <td valign="top" width="330"><strong><?php echo JText::_('COM_JDOWNLOADS_BACKEND_SETTINGS_HTML5_BOX_AUDIO_WIDTH_TITLE')." "; ?></strong><br />
                       ...
                       <tr>
                        ...
                        <tr>
                        <td valign="top" width="330"><strong><?php echo JText::_('COM_JDOWNLOADS_BACKEND_SETTINGS_FLOW_USE_TITLE')." "; ?></strong><br />
                        ...
                        <tr>
                        <td valign="top" width="330"><strong><?php echo JText::_('COM_JDOWNLOADS_BACKEND_SETTINGS_FLOW_BOX_WIDTH_TITLE')." "; ?></strong><br />
                        ...
                        <tr>
                        <td valign="top" width="330"><strong><?php echo JText::_('COM_JDOWNLOADS_BACKEND_SETTINGS_FLOW_BOX_HEIGHT_TITLE')." "; ?></strong><br />
                        ...
                        <tr>
                        <td valign="top" width="330"><strong><?php echo JText::_('COM_JDOWNLOADS_BACKEND_SETTINGS_FLOW_BOX_HEIGHT_MP3_TITLE')." "; ?></strong><br />
                        ...
                        <tr>
                        <td valign="top" width="330"><strong><?php echo JText::_('COM_JDOWNLOADS_BACKEND_SETTINGS_FLOW_SETTINGS_TITLE')." "; ?></strong><br />
                       ...
                       <tr>
                        ...
                        <tr>
                        <td valign="top" width="330"><strong><?php echo JText::_('COM_JDOWNLOADS_BACKEND_SETTINGS_MP3_CONFIG_TITLE')." "; ?></strong><br />
                        ...
                        <tr>
                        <td valign="top" width="330"><strong><?php echo JText::_('COM_JDOWNLOADS_BACKEND_SETTINGS_MP3_CONFIG_VIEW_ID3_TITLE')." "; ?></strong><br />
                        ...
                        <tr>
                        <td valign="top" width="330"><strong><?php echo JText::_('COM_JDOWNLOADS_BACKEND_SETTINGS_MP3_CONFIG_VIEW_ID3_LAY_TITLE')." "; ?></strong><br />
                ...
                <table cellpadding="4" cellspacing="1" border="0" class="adminlist">
                  <tr>
                      ...
                      <th class="adminheading" colspan="2"><?php echo JText::_('COM_JDOWNLOADS_UPLOADER_TITLE_HEAD'); ?></th>
                        ...
                        <tr>
                        <td valign="top" width="330"><strong><?php echo JText::_('COM_JDOWNLOADS_UPLOADER_RUNTIME_LABEL')." "; ?></strong><br />
                        <?php
                        ...
                        <tr>
                        <td valign="top" width="330"><strong><?php echo JText::_('COM_JDOWNLOADS_UPLOADER_MAX_FILE_SIZE')." "; ?></strong><br />
                        ...
                        <tr>
                        <td valign="top" width="330"><strong><?php echo JText::_('COM_JDOWNLOADS_UPLOADER_CHUNK_SIZE')." "; ?></strong><br />
                        ...
                        <tr>
                        <td valign="top" width="330"><strong><?php echo JText::_('COM_JDOWNLOADS_UPLOADER_CHUNK_UNIT')." "; ?></strong><br />
                        <?php
                        ...
                        <tr>
                        <td valign="top" width="330"><strong><?php echo JText::_('COM_JDOWNLOADS_UPLOADER_RENAME')." "; ?></strong><br />
                        ...
                        <tr>
                        <td valign="top" width="330"><strong><?php echo JText::_('COM_JDOWNLOADS_UPLOADER_IMAGE_FILE_EXTENSIONS')." "; ?></strong><br />
                        ...
                        <tr>
                        <td valign="top" width="330"><strong><?php echo JText::_('COM_JDOWNLOADS_UPLOADER_OTHER_FILE_EXTENSIONS')." "; ?></strong><br />
                        ...
                        <tr>
                        <td valign="top" width="330"><strong><?php echo JText::_('COM_JDOWNLOADS_UPLOADER_UNIQUE_NAMES')." "; ?></strong><br />
                        ...
                        <tr>
                        <td valign="top" width="330"><strong><?php echo JText::_('COM_JDOWNLOADS_UPLOADER_ENABLE_IMAGE_RESIZING')." "; ?></strong><br />
                        ...
                        <tr>
                        <td valign="top" width="330"><strong><?php echo JText::_('COM_JDOWNLOADS_UPLOADER_RESIZE_WIDTH')." "; ?></strong><br />
                        ...
                        <tr>
                        <td valign="top" width="330"><strong><?php echo JText::_('COM_JDOWNLOADS_UPLOADER_RESIZE_HEIGHT')." "; ?></strong><br />
                        ...
                        <tr>
                        <td valign="top" width="330"><strong><?php echo JText::_('COM_JDOWNLOADS_UPLOADER_RESIZE_QUALITY')." "; ?></strong><br />
                        ...
                        <tr>
                             <td valign="top" width="330"><strong><?php echo JText::_('COM_JDOWNLOADS_UPLOADER_ENABLE_LOG')." "; ?></strong><br />
...
<?php /* Backend config */ ?>
                ...
                <tr>
                  ...
                  <tr>
                     <td valign="top" width="330"><strong><?php echo JText::_('COM_JDOWNLOADS_BACKEND_BLACKLIST_TITLE')." "; ?></strong><br />
                  ...
                  <tr>
                      <td valign="top" align="left" width="100%">
                       <table width="100%">
                        ...
                        <tr>
                        <td valign="top" width="330"><strong><?php echo JText::_('COM_JDOWNLOADS_BACKEND_SETTINGS_SEND_MAILTO_OPTION')." "; ?></strong><br />
                        ...
                        <tr>
                        <td valign="top" width="330"><strong><?php echo JText::_('COM_JDOWNLOADS_BACKEND_SETTINGS_SEND_MAILTO_HTML')." "; ?></strong><br />
                        ...
                        <tr>
                        <td valign="top" width="330"><strong><?php echo JText::_('COM_JDOWNLOADS_BACKEND_SETTINGS_SEND_MAILTO')." "; ?></strong><br />
                        ...
                        <tr>
                        <td valign="top" width="330"><strong><?php echo JText::_('COM_JDOWNLOADS_BACKEND_SETTINGS_SEND_MAILTO_BETREFF')." "; ?></strong><br />
                                <input name="jlistConfig[send.mailto.betreff]" value="<?php echo htmlspecialchars($jlistConfig['send.mailto.betreff'], ENT_QUOTES ); ?>" size="50" maxlength="500"/></td>
                        <td>
                            <br />
                        ...
                        <tr>
                          <td valign="top" width="330"><strong><?php echo JText::_('COM_JDOWNLOADS_BACKEND_SETTINGS_GLOBAL_MAIL_UPLOAD_TEMPLATE_TITLE')." "; ?></strong><br />
                  ...
                  <tr>
                      <td valign="top" align="left" width="100%">
                       <table width="100%">
                        ...
                        <tr>
                        <td valign="top" width="330"><strong><?php echo JText::_('COM_JDOWNLOADS_BACKEND_SETTINGS_SEND_MAILTO_BETREFF')." "; ?></strong><br />
                                <input name="jlistConfig[send.mailto.betreff.upload]" value="<?php echo htmlspecialchars($jlistConfig['send.mailto.betreff.upload'], ENT_QUOTES ); ?>" size="50" maxlength="500"/></td>
                        <td>
                            <br />
                            <?php echo JText::_('COM_JDOWNLOADS_BACKEND_SETTINGS_SEND_MAILTO_BETREFF_DESC').' '.JText::_('COM_JDOWNLOADS_MULTILANGUAGE_TEXT_FIELD_INFO_SHORT');?>
                        </td>
                  ...
                  <tr>
                      <td valign="top" align="left" width="100%">
                       <table width="100%">
                        ...
                        <tr>
                        <td valign="top" width="330"><strong><?php echo JText::_('COM_JDOWNLOADS_BACKEND_SETTINGS_SEND_MAILTO_BETREFF'); ?></strong><br />
                               <input name="jlistConfig[report.mail.subject]" value="<?php echo htmlspecialchars($jlistConfig['report.mail.subject'], ENT_QUOTES ); ?>" size="50" maxlength="500"/>
                        </td>
                        <td valign="top">
                            <br />
                            <?php echo JText::_('COM_JDOWNLOADS_BACKEND_SETTINGS_SEND_MAILTO_BETREFF_DESC').' '.JText::_('COM_JDOWNLOADS_MULTILANGUAGE_TEXT_FIELD_INFO_SHORT');?>
                        ...
                        <tr>
                        <td valign="top" width="330"><strong><?php echo JText::_('COM_JDOWNLOADS_CONFIG_REPORT_FILE_MAIL_LAYOUT')." "; ?></strong><br />
           ...
           <table cellpadding="4" cellspacing="1" border="0" class="adminlist">
                <tr>
                    <td valign="top" align="left" width="100%">
                        ...
                        <tr>
                        <td valign="top" width="330"><strong><?php echo JText::_('COM_JDOWNLOADS_BACKEND_SETTINGS_ADSENSE_ACTIVATE_TITLE')." "; ?></strong><br />
                        ...
                        <tr>
                        <td valign="top" width="330"><strong><?php echo JText::_('COM_JDOWNLOADS_BACKEND_SETTINGS_ADSENSE_CODE_TITLE')." "; ?></strong><br />
      ...
      <td>
         <table cellpadding="4" cellspacing="1" border="0" class="adminlist">
                ...
                <tr><td colspan="2"><font color="#990000"><?php echo JText::_('COM_JDOWNLOADS_BACKEND_SET_AUP_HEADER_TEXT'); ?></font></td></tr>                      
                     <tr>
                        <td valign="top" width="330"><strong><?php echo JText::_('COM_JDOWNLOADS_BACKEND_SET_AUP_TITLE')." "; ?></strong><br />
                      ...
                      <tr>
                        <td valign="top" width="330"><strong><?php echo JText::_('COM_JDOWNLOADS_BACKEND_SET_AUP_DOWNLOAD_WHEN_ZERO_POINTS_TEXT')." "; ?></strong><br />
                               <?php echo JDownloadsHelper::yesnoSelectList( 'jlistConfig[user.can.download.file.when.zero.points]', 'class="inputbox", disabled', $jlistConfig['user.can.download.file.when.zero.points']); ?> 
                        </td>
                        <td>
                        <br />
                      ...
                      <tr>
                        <td valign="top" width="330"><strong><?php echo JText::_('COM_JDOWNLOADS_BACKEND_SET_AUP_FE_MESSAGE_NO_DOWNLOAD_EDIT')." "; ?></strong><br />
                                ...
                                <td valign="top"><br /><?php echo JText::_('COM_JDOWNLOADS_BACKEND_SET_AUP_FE_MESSAGE_NO_DOWNLOAD_DESC').'<br /><br />'.JText::_('COM_JDOWNLOADS_MULTILANGUAGE_TEXT_FIELD_INFO_SHORT');?>
                                </td>
                      </tr>
                      <tr>
                        <td valign="top" width="330"><strong><?php echo JText::_('COM_JDOWNLOADS_BACKEND_SET_AUP_USE_FILE_PRICE_TITLE')." "; ?></strong><br />
                 ...
                 <td>
                  ...
                  <tr>
                     ...
                     if ($jlistConfig['com'] == ''){ ?>   
                       ...
                       <tr>
                        <td valign="top" width="330"><strong><?php echo JText::_('COM_JDOWNLOADS_BACKEND_POST_COM_ID_TITLE2')." "; ?></strong><br />
         ...
         <tr>
           <td valign="top" align="left" width="50%">
              <table width="100%">
               ...
               <tr>
                <td valign="top" width="330"><strong><?php echo JText::_('COM_JDOWNLOADS_BACKEND_SETTINGS_FILEPLUGIN_ENABLEPLUGIN')." "; ?></strong><br />
               ...
               <tr>
                <td valign="top" width="330"><strong><?php echo JText::_('COM_JDOWNLOADS_BACKEND_SETTINGS_FILEPLUGIN_SHOWDISABLED')." "; ?></strong><br />
               ...
               <tr>
                <td valign="top" width="330"><strong><?php echo JText::_('COM_JDOWNLOADS_BACKEND_SETTINGS_FILEPLUGIN_DOWNLOADTITLE')." "; ?></strong><br />
               ...
               <tr>
                 <td valign="top" width="330"><strong><?php echo JText::_('COM_JDOWNLOADS_BACKEND_SETTINGS_FILEPLUGIN_OFFLINETITLE')." "; ?></strong><br />
               ...
               <tr>
                 <td valign="top" width="330"><strong><?php echo JText::_('COM_JDOWNLOADS_BACKEND_SETTINGS_FILEPLUGIN_OFFLINEDESC')." "; ?></strong><br />
